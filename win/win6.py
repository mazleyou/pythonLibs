...
df = pandas.DataFrame(columns=("f1", "f2", "f3", "f4", "f5", "f6", "label"))
...
column_names = ["f1", "f2", "f3", "f4", "f5", "f6", "label"]
...
if not os.path.exists(modelfilename):
    ...
    model = tf.keras.Sequential([
      tf.keras.layers.Dense(10, activation=tf.nn.relu, input_shape=(6,)),  # 입력의 형태가 필요합니다.
